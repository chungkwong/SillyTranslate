 ...
 */
public class YapSentenceTranslator implements SentenceTranslatorEngine{
	private final int limit;
	private final Locale locale;
	private String rules;
	public YapSentenceTranslator(int limit,File src,Locale locale){
		this.limit=limit;
		this.locale=locale;
		try{
	...
	public static void main(String[] args) throws IOException, InterruptedException{
		...
		YapSentenceTranslator translator=new YapSentenceTranslator(10,new File("src/com/github/chungkwong/sillytranslate/sentence/RULES2.prolog"),Locale.CHINESE);
